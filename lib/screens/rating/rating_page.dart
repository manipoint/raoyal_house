...
import 'package:raoyal_house/screens/rating/rating_dialog.dart';
...
class RatingPage extends StatefulWidget {
  ...
  const RatingPage({Key? key, required this.product}) : super(key: key);
  @override
  _RatingPageState createState() => _RatingPageState(product);
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: <Widget>[
            IconButton(
              icon: Image.network(product!.picture!),
              onPressed: () {
                // showDialog(
                //     context: context,
                //     child: Dialog(
