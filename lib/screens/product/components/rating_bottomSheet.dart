...
class RatingBottomSheet extends StatefulWidget {
  ...
  const RatingBottomSheet({Key? key, required this.product}) : super(key: key);
  @override
  _RatingBottomSheetState createState() => _RatingBottomSheetState(product);
}
...
class _RatingBottomSheetState extends State<RatingBottomSheet> {
  ...
  _RatingBottomSheetState(this.product);
